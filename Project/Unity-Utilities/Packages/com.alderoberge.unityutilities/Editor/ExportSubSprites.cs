...
namespace AldeRoberge.UnityUtilities.Editor
{
     ...
     * From https://stackoverflow.com/questions/55844965/can-you-export-sliced-sprites-png-images-in-unity.
        ...
        Sprite also need to be configured in specific way for this to work, so check your main spritesheet that: "Mesh Type = Full Rect" and "Advanced>Read/Write Enabled = true"
     */
